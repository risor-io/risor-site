...
well-received, the Tamarin code can be easily transformed into raw Go as needed.
...
Scripting languages are often used as "glue code". Tamarin is handy for
stitching together different systems due to its lightweight nature. Running a
Tamarin script (instead of compiling a Go binary) is great for small integration
