...
Risor leverages Go's concurrency primitives and supports spawning goroutines and
communicating via channels. Channels can be used to send any Risor object type.
